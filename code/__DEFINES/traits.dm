...
#define TRAIT_HEATWEAKNESS		"heat_weakness"
#define TRAIT_COLDWEAKNESS		"cold_weakness"
#define TRAIT_HIGHPRESSUREWEAKNESS	"high_pressure_weakness"
#define TRAIT_LOWPRESSUREWEAKNESS	"low_pressure_weakness"
